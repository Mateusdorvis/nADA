...
class Login(BaseCadastro):
    def __init__(self, root):
        ...
        self.label_reg = Labelcustomizada(self.frame_caixa, text='Não tem cadastro ? Clique no botão ao lado para fazer cadastro.',)
        ...
        self.button_reg.grid(row=19, column=1, pady=5, padx=5)
