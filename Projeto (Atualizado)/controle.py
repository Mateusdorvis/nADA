...
class Controle:
    ...
    def dicas_nome(self, event):
        ...
        if self.ler_nome >= 5 and self.ler_nome <= 9:
            ...
            Mensagens.msgAtencao(f'Seu nome de usuário chegou ao número de caractere máximo, pois tem {self.ler_nome}!')
    ...
    def dicas_senha(self, event):
        ...
        if self.ler_senha >= 5 and self.ler_senha <= 9:
            ...
            Mensagens.msgAtencao(f'Sua senha de usuário chegou ao número de caractere máximo, pois tem {self.ler_senha}!')
